          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                ...
                <div className="text-indigo-100">אתגרים זמינים</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="text-2xl font-bold">
                  {challenges.filter(c => c.isMonthlyChallenge).length}
                </div>
                <div className="text-indigo-100">אתגרים חודשיים</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="text-2xl font-bold">
                  {new Set(challenges.map(c => c.ageGroup)).size}
                </div>
                <div className="text-indigo-100">קבוצות גיל</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="text-2xl font-bold">
                  {new Set(challenges.map(c => c.category)).size}
                </div>
                <div className="text-indigo-100">קטגוריות</div>
              </div>
            </div>
          </div>
        </section>
