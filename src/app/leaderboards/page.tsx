      ...
      <ProtectedRoute>
        <div className="min-h-screen bg-background flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-text-muted">טוען דירוגים...</p>
          </div>
        </div>
      </ProtectedRoute>
    )
      ...
      <ProtectedRoute>
        <div className="min-h-screen bg-background flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-text-primary mb-4">שגיאה בטעינת הדירוגים</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                ...
                <div className="text-primary-100">סה"כ שחקנים</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="text-2xl font-bold">{stats.averagePoints}</div>
                <div className="text-primary-100">נקודות ממוצעות</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="text-2xl font-bold">{stats.topScore}</div>
                <div className="text-primary-100">הציון הגבוה ביותר</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="text-2xl font-bold">
                  {stats.levelDistribution.advanced || 0}
                </div>
                <div className="text-primary-100">שחקנים מתקדמים</div>
              </div>
            </div>
          </div>
        </section>
